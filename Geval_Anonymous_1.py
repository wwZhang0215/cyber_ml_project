...
def main(clean_data_filename, poisoned_data_filename, bd_model_filename, prune_model_filename):
...
if __name__ == '__main__':
    ...
    prune_model_filename = "models/repair_anonymous_1_bd_net.h5"
    ...
    #         prune_model_filename = "repair_anonymous_1_bd_net_" + str(i) + "_" + str(j) + ".h5"
